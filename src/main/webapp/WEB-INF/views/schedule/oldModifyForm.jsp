	...
	<div class="container-contact100">
		<div class="wrap-contact100">
				<form class="contact100-form validate-form" method="post" action="modifyTest" id="mofiy-form">
					...
					<span class="label-input100"><Strong>센터 - 기존</Strong></span>
						<div>
							<div>
								<input type="text" class="wrap-input100 input100-select bg1" id="centerOld" name="centerOld" disabled/>
							</div>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><strong>센터 - 신규</strong></span>
						<div>
							<select class="js-select2" name="center" id="center">
								<option value="">변경할 센터를 선택해주세요.</option>
								<c:forEach var="dtos" items="${scloDto }">
									<c:if test="${dtos.centerStatus eq 'N'}">
										<option value="${dtos.centerNo}">${dtos.centerLocation } : ${dtos.centerName }
									</c:if>
								</c:forEach>
							</select>
							<div class="dropDownSelect2"></div>
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>정원수 - 기존</Strong></span>
						<div>
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						...
						<div>
							<input type="number" class="wrap-input100 input100-select bg1" id="quota" name="quota" value="0"/>
						</div>
					</div>
					
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>시험일자 - 기존</Strong></span>
						<div>
							<input type="datetime-local" class="wrap-input100 input100-select bg1" id="testDateOld" name="testDateOld" disabled/>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>접수시작일 - 기존</Strong></span>
						<div>
							<input type="datetime-local" class="wrap-input100 input100-select bg1" id="receiptOld" name="receiptOld" disabled/>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>접수마감일 - 기존</Strong></span>
						<div>
							<input type="datetime-local" class="wrap-input100 input100-select bg1" id="deadlineOld" name="deadlineOld" disabled/>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>성적발표예정일 - 기존</Strong></span>
						<div>
							<input type="datetime-local" class="wrap-input100 input100-select bg1" id="expectedDateOld" name="expectedDateOld" disabled/>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
					...
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>시험상태 - 기존</Strong></span>
						<div>
							<input type="text" class="wrap-input100 input100-select bg1" id="statusOld" name="statusOld" disabled/>
						</div>
					</div>
					<div class="wrap-input100 input100-select bg1 col-6">
						<span class="label-input100"><Strong>시험상태 - 신규</Strong></span>
							<select class="js-select2" name="statusValue">
...
<script type="text/javascript">
	...
	var status = value.substring(74,75);
	var quotaOld = value.substring(76,78);
	var centerLocation = value.substring(79,81);
	var centerName = value.substring(82);
	...
	$("#receiptOld").val(RD);
	$("#deadlineOld").val(DLD);
	$("#expectedDateOld").val(ED);
	$("#quotaOld").val(quotaOld);
	$("#centerOld").val(centerLocation +" : " + centerName);
